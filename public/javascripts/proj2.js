...
function initBuffer() {
  canvas = document.getElementById("proj2canvas");
...
function init() {
    ...
    document.getElementById("proj2").appendChild(cssRenderer.domElement);
    ...
    renderer.setSize(WIDTH,HEIGHT);
		...
		document.getElementById("proj2").appendChild(renderer.domElement);
