...
function initBuffer() {
  canvas = document.getElementById("proj3canvas");
...
function init() {
    ...
    document.getElementById("proj3").appendChild(cssRenderer.domElement);
    ...
    renderer.setSize(WIDTH,HEIGHT);
		...
		document.getElementById("proj3").appendChild(renderer.domElement);
